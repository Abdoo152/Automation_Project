...
public class TestCase3LoginUserWithIncorrectData {
    ...
    @Test(description = "Verify error 'Your email or password is incorrect!' is visible")
    private void verifyingIncorrectEmailAddressAndPassword(){
        ...
        new LoginUserPage(driver).verifyingLoginToYourAccountIcon()
                .fillEmailAddress(testData.getTestData("userInfo['wrongEmailAddress']"))
                .fillPassword(testData.getTestData("userInfo['wrongPassword']"))
                .clickOnLoginButton()
                .verifyingIncorrectEmailAddressAndPassword();
    }
